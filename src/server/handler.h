...
#define WARDS_LI_ITEM "<li><a class=\"flex justify-center rounded-md border-white border border-opacity-10 bg-none bg-opacity-5 p-1\" href=\"/o/%1$s\">%1$s</a></li>"
#define TEACHERS_LI_ITEM "<li><a class=\"flex justify-center rounded-md border-white border border-opacity-10 bg-none bg-opacity-5 p-1\" href=\"/n/%1$s\">%2$s (%1$s)</a></li>"
#define CLASSROOM_LI_ITEM "<li><a class=\"flex justify-center rounded-md border-white border border-opacity-10 bg-none bg-opacity-5 p-1\" href=\"/s/%1$s\">%1$s</a></li>"
